                ...
                <div class="col-12">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <form  method="POST" action="{{url('admin/category/action')}}">
                                @csrf
                                @method('POST')
                                ...
                                text-align: center">
                                    ...
                                    @if($productCategory->total()>0)
                                        @foreach($productCategory as $productCategorys)
                                            <tr>
                                                <td><input type="checkbox" name="list_check[]" value="{{$productCategorys->id}}"></td>
                                                <td>
                                                    <div class="avatar avatar-sm">
                                                        <p class="mb-0 text-muted">{{$productCategorys->id}}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="mb-0 text-muted"><strong></strong></p>
                                                    <small class="mb-0 text-muted"><strong>{{$productCategorys->name}}</strong></small>
                                                </td>
                                                <td>
                    ...
                    <nav aria-label="Table Paging" class="my-3">
                        <ul class="pagination justify-content-end mb-0">
                            {!! $productCategory->appends(app("request")->input())->links("pagination::bootstrap-4") !!}
                        </ul>
                    </nav>
                </div> <!-- .col-12 -->
            </div> <!-- .row -->
