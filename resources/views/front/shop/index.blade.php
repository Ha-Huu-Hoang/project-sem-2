            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="front/img/product/product-13.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="front/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="front/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="front/img/product/product-14.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="front/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="front/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
